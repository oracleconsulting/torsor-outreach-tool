...
import { Building2, Search, MapPin, Users, Shield, History, LogOut, Bell, Network, ClipboardCheck } from 'lucide-react'
...
const navItems = [
  ...
  { path: '/bulk-office-check', label: 'Bulk Office Check', icon: ClipboardCheck },
